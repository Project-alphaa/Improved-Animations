...
public class LocatorRig {
    ...
    public void animateLocatorAdditive(Locator locator, ChannelTimeline channelTimeline, float time, float weightRotation, float weightTranslation, boolean mirrored){
        ...
        locator.rotateWorldSpace(channelTimeline.getValueAt(TransformChannel.X_ROT, time) * weightRotation, channelTimeline.getValueAt(TransformChannel.Y_ROT, time) * weightRotation * mirrorMultiplier, channelTimeline.getValueAt(TransformChannel.Z_ROT, time) * weightRotation * mirrorMultiplier);
    }
